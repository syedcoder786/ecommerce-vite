    ...
    <div>
        <div className="space-y-6">
              ...
              <div>
                ...
                <TextInput id="text" name="name" value={name} placeholder="Name" required onChange={onRegisterChange}/>
              </div>
              ...
              <div>
                ...
                <TextInput id="email" name="email" value={email} placeholder="name@company.com" required onChange={onRegisterChange}/>
              </div>
              <div>
                <div className="mb-2 block">
                  <Label htmlFor="password" value="Your password" />
                </div>
                <TextInput id="password" name="password" value={password} type="password" required onChange={onRegisterChange}/>
              </div>
